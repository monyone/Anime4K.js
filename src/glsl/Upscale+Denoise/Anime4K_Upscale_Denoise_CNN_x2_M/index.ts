...
export default class Anime4K_UpscaleDenoise_CNN_x2_M {
  ...
  public render(info: TextureData): TextureData {
    ...
    }
    {
      ...
      const mainTextureLocation = gl.getUniformLocation(this.#conv2d_1_tf, "conv2d_tf");
      gl.uniform1i(mainTextureLocation, 0);
    ...
    }
    {
      ...
      const mainTextureLocation = gl.getUniformLocation(this.#conv2d_2_tf, "conv2d_1_tf");
      gl.uniform1i(mainTextureLocation, 0);
    ...
    }
    {
      ...
      const mainTextureLocation = gl.getUniformLocation(this.#conv2d_3_tf, "conv2d_2_tf");
      gl.uniform1i(mainTextureLocation, 0);
    ...
    }
    {
      ...
      const mainTextureLocation = gl.getUniformLocation(this.#conv2d_4_tf, "conv2d_3_tf");
      gl.uniform1i(mainTextureLocation, 0);
    ...
    }
    {
      ...
      const mainTextureLocation = gl.getUniformLocation(this.#conv2d_5_tf, "conv2d_4_tf");
      gl.uniform1i(mainTextureLocation, 0);
    ...
    }
    {
      ...
      const mainTextureLocation = gl.getUniformLocation(this.#conv2d_6_tf, "conv2d_5_tf");
      gl.uniform1i(mainTextureLocation, 0);
    ...
    }
    {
      ...
      const conv2d_tf_Location = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_tf");
      gl.uniform1i(conv2d_tf_Location, 0);
      const conv2d_1_tf_Location = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_1_tf");
      gl.uniform1i(conv2d_1_tf_Location, 1);
      const conv2d_2_tf_Location = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_2_tf");
      gl.uniform1i(conv2d_2_tf_Location, 2);
      const conv2d_3_tf_Location = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_3_tf");
      gl.uniform1i(conv2d_3_tf_Location, 3);
      const conv2d_4_tf_Location = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_4_tf");
      gl.uniform1i(conv2d_4_tf_Location, 4);
      const conv2d_5_tf_Location = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_5_tf");
      gl.uniform1i(conv2d_5_tf_Location, 5);
      const conv2d_6_tf_Location = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_6_tf");
      gl.uniform1i(conv2d_6_tf_Location, 6);
    ...
    }
    {
      ...
      const cnnTextureLocation = gl.getUniformLocation(this.#main, "conv2d_last_tf");
      gl.uniform1i(cnnTextureLocation, 0);
      const mainTextureLocation = gl.getUniformLocation(this.#main, "MAIN");
      gl.uniform1i(mainTextureLocation, 1);
