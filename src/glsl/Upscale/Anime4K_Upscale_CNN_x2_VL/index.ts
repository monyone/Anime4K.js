...
import conv2d_last_tf from './conv2d_last_tf.glsl';
import conv2d_last_tf1 from './conv2d_last_tf1.glsl';
import conv2d_last_tf2 from './conv2d_last_tf2.glsl';
import main from './MAIN.glsl';

export default class Anime4K_Upscale_CNN_x2_VL {
  ...
  #conv2d_last_tf: WebGLProgram;
  #conv2d_last_tf1: WebGLProgram;
  #conv2d_last_tf2: WebGLProgram;
  #main: WebGLProgram;
  ...
  #conv2d_last_tf_tex: WebGLTexture;
  #conv2d_last_tf1_tex: WebGLTexture;
  #conv2d_last_tf2_tex: WebGLTexture;
  ...
  public constructor(gl: WebGLRenderingContext) {
    ...
    this.#conv2d_last_tf = createProgram(gl,
      createVertexShader(gl, noflip)!,
      createFragmentShader(gl, conv2d_last_tf)!,
    )!;
    this.#conv2d_last_tf1 = createProgram(gl,
      createVertexShader(gl, noflip)!,
      createFragmentShader(gl, conv2d_last_tf1)!,
    )!;
    this.#conv2d_last_tf2 = createProgram(gl,
      createVertexShader(gl, noflip)!,
      createFragmentShader(gl, conv2d_last_tf2)!,
    )!;
    ...
    this.#conv2d_last_tf_tex = createTexture(gl, gl.NEAREST)!;
    this.#conv2d_last_tf1_tex = createTexture(gl, gl.NEAREST)!;
    this.#conv2d_last_tf2_tex = createTexture(gl, gl.NEAREST)!;
  ...
  public render(info: TextureData): TextureData {
    ...
    {
      this.#setupCommonSetting(this.#conv2d_last_tf,
        { texture: this.#conv2d_6_tf_tex, width: in_width, height: in_height },
        { texture: this.#conv2d_last_tf_tex, width: in_width, height: in_height },
      );
      ...
      const conv2d_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_tf");
      gl.uniform1i(conv2d_tf_TextureLocation, 0);
      const conv2d_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_tf1");
      gl.uniform1i(conv2d_tf1_TextureLocation, 1);
      const conv2d_1_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_1_tf");
      gl.uniform1i(conv2d_1_tf_TextureLocation, 2);
      const conv2d_1_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_1_tf1");
      gl.uniform1i(conv2d_1_tf1_TextureLocation, 3);
      const conv2d_2_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_2_tf");
      gl.uniform1i(conv2d_2_tf_TextureLocation, 4);
      const conv2d_2_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_2_tf1");
      gl.uniform1i(conv2d_2_tf1_TextureLocation, 5);
      const conv2d_3_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_3_tf");
      gl.uniform1i(conv2d_3_tf_TextureLocation, 6);
      const conv2d_3_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_3_tf1");
      gl.uniform1i(conv2d_3_tf1_TextureLocation, 7);
      const conv2d_4_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_4_tf");
      gl.uniform1i(conv2d_4_tf_TextureLocation, 8);
      const conv2d_4_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_4_tf1");
      gl.uniform1i(conv2d_4_tf1_TextureLocation, 9);
      const conv2d_5_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_5_tf");
      gl.uniform1i(conv2d_5_tf_TextureLocation, 10);
      const conv2d_5_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_5_tf1");
      gl.uniform1i(conv2d_5_tf1_TextureLocation, 11);
      const conv2d_6_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_6_tf");
      gl.uniform1i(conv2d_6_tf_TextureLocation, 12);
      const conv2d_6_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf, "conv2d_6_tf1");
      gl.uniform1i(conv2d_6_tf1_TextureLocation, 13);

      gl.drawArrays(gl.TRIANGLES, 0, 6);
    }
    {
      this.#setupCommonSetting(this.#conv2d_last_tf1,
        { texture: this.#conv2d_6_tf1_tex, width: in_width, height: in_height },
        { texture: this.#conv2d_last_tf1_tex, width: in_width, height: in_height },
      );
      ...
      const conv2d_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_tf");
      gl.uniform1i(conv2d_tf_TextureLocation, 0);
      const conv2d_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_tf1");
      gl.uniform1i(conv2d_tf1_TextureLocation, 1);
      const conv2d_1_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_1_tf");
      gl.uniform1i(conv2d_1_tf_TextureLocation, 2);
      const conv2d_1_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_1_tf1");
      gl.uniform1i(conv2d_1_tf1_TextureLocation, 3);
      const conv2d_2_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_2_tf");
      gl.uniform1i(conv2d_2_tf_TextureLocation, 4);
      const conv2d_2_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_2_tf1");
      gl.uniform1i(conv2d_2_tf1_TextureLocation, 5);
      const conv2d_3_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_3_tf");
      gl.uniform1i(conv2d_3_tf_TextureLocation, 6);
      const conv2d_3_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_3_tf1");
      gl.uniform1i(conv2d_3_tf1_TextureLocation, 7);
      const conv2d_4_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_4_tf");
      gl.uniform1i(conv2d_4_tf_TextureLocation, 8);
      const conv2d_4_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_4_tf1");
      gl.uniform1i(conv2d_4_tf1_TextureLocation, 9);
      const conv2d_5_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_5_tf");
      gl.uniform1i(conv2d_5_tf_TextureLocation, 10);
      const conv2d_5_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_5_tf1");
      gl.uniform1i(conv2d_5_tf1_TextureLocation, 11);
      const conv2d_6_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_6_tf");
      gl.uniform1i(conv2d_6_tf_TextureLocation, 12);
      const conv2d_6_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf1, "conv2d_6_tf1");
      gl.uniform1i(conv2d_6_tf1_TextureLocation, 13);

      gl.drawArrays(gl.TRIANGLES, 0, 6);
    }
    {
      this.#setupCommonSetting(this.#conv2d_last_tf2,
        { texture: this.#conv2d_6_tf1_tex, width: in_width, height: in_height },
        { texture: this.#conv2d_last_tf2_tex, width: in_width, height: in_height },
      );
      ...
      const conv2d_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_tf");
      gl.uniform1i(conv2d_tf_TextureLocation, 0);
      const conv2d_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_tf1");
      gl.uniform1i(conv2d_tf1_TextureLocation, 1);
      const conv2d_1_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_1_tf");
      gl.uniform1i(conv2d_1_tf_TextureLocation, 2);
      const conv2d_1_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_1_tf1");
      gl.uniform1i(conv2d_1_tf1_TextureLocation, 3);
      const conv2d_2_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_2_tf");
      gl.uniform1i(conv2d_2_tf_TextureLocation, 4);
      const conv2d_2_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_2_tf1");
      gl.uniform1i(conv2d_2_tf1_TextureLocation, 5);
      const conv2d_3_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_3_tf");
      gl.uniform1i(conv2d_3_tf_TextureLocation, 6);
      const conv2d_3_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_3_tf1");
      gl.uniform1i(conv2d_3_tf1_TextureLocation, 7);
      const conv2d_4_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_4_tf");
      gl.uniform1i(conv2d_4_tf_TextureLocation, 8);
      const conv2d_4_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_4_tf1");
      gl.uniform1i(conv2d_4_tf1_TextureLocation, 9);
      const conv2d_5_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_5_tf");
      gl.uniform1i(conv2d_5_tf_TextureLocation, 10);
      const conv2d_5_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_5_tf1");
      gl.uniform1i(conv2d_5_tf1_TextureLocation, 11);
      const conv2d_6_tf_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_6_tf");
      gl.uniform1i(conv2d_6_tf_TextureLocation, 12);
      const conv2d_6_tf1_TextureLocation = gl.getUniformLocation(this.#conv2d_last_tf2, "conv2d_6_tf1");
      gl.uniform1i(conv2d_6_tf1_TextureLocation, 13);
    ...
    }
    {
      this.#setupCommonSetting(this.#main,
        { texture: this.#conv2d_last_tf_tex, width: in_width, height: in_height },
        { texture: this.#main_tex, width: out_width, height: out_height },
      );

      gl.activeTexture(gl.TEXTURE0);
      gl.bindTexture(gl.TEXTURE_2D, this.#conv2d_last_tf_tex);
      gl.activeTexture(gl.TEXTURE1);
      gl.bindTexture(gl.TEXTURE_2D, this.#conv2d_last_tf1_tex);
      gl.activeTexture(gl.TEXTURE2);
      gl.bindTexture(gl.TEXTURE_2D, this.#conv2d_last_tf2_tex);
      gl.activeTexture(gl.TEXTURE3);
      gl.bindTexture(gl.TEXTURE_2D, info.texture);

      const conv2d_last_tf_TextureLocation = gl.getUniformLocation(this.#main, "conv2d_last_tf");
      gl.uniform1i(conv2d_last_tf_TextureLocation, 0);
      const conv2d_last_tf1_TextureLocation = gl.getUniformLocation(this.#main, "conv2d_last_tf1");
      gl.uniform1i(conv2d_last_tf1_TextureLocation, 1);
      const conv2d_last_tf2_TextureLocation = gl.getUniformLocation(this.#main, "conv2d_last_tf2");
      gl.uniform1i(conv2d_last_tf2_TextureLocation, 2);
      const mainTextureLocation = gl.getUniformLocation(this.#main, "MAIN");
      gl.uniform1i(mainTextureLocation, 3);
